...
if($_SESSION['UserIDLocked'] == "locked"){
    header("Location:lockscreen?pg=citizen");
}
...
$resultID = mysqli_query($con,"SELECT * FROM `complaints` WHERE `ComplaintID` = '$ComplaintID'");
$resID = mysqli_fetch_array($resultID);   
$ComplaintID = $resID['id'];
...
$htmlContentPersonel = '
    ...
    <script>
        Snackbar.show({
            text: 'There was an issue while trying to send your complaint. Please try again later.',
            pos: 'top-right',
            actionTextColor: '#fff',
...
$htmlContent = '
    ...
    $headers = "From: Complaint Tracker Team <noreply@ct.co.za>";
        ...
        $mail = @mail("delegate@thaboirvinservices.co.za", $email_subject, $message, $headers, $returnpath);
    ...
    <div class="main-container sidebar-closed " id="container">
        ...
        <div class="modal fade" id="addTaskModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered " role="document">
                <form class="modal-content" action="citizen" method="POST">
                        ...
                        <div class="compose-box">
                            <div class="compose-content" id="addTaskModalTitle">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" readonly value="<?php echo $res['FirstName']; ?>" name="FirstName" required type="text" id="FirstName" placeholder="First Name">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="password">Last Name</label>
                                    <input class="form-control" readonly value="<?php echo $res['LastName']; ?>" name="LastName" required type="text" id="LastName" placeholder="LastName">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="password">Email Address</label>
                                    <input class="form-control" readonly value="<?php echo $res['EmailAddress']; ?>" type="email" id="emailaddress" name="emailAddress" required="" placeholder="Email address">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="password">Contact Number</label>
                                    <input class="form-control" readonly value="<?php echo $res['ContactNumber']; ?>" type="text" id="contactNumber" name="contactNumber" required="" placeholder="Contact Number">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="password">Physical Address</label>
                                    <input class="form-control" readonly value="<?php echo $res['Address']; ?>" type="text" id="Address" name="physicalAddress" required="" placeholder="Physical address">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="todo-box">
                                    ...
                                    <div id="ct" class="todo-box-scroll">
                                        <?php
                                            ...
                                            $result = mysqli_query($con,"SELECT * FROM `complaints` WHERE `ComplaintStatus` = 'Waiting' AND `LoggerID` = '$UserID' ORDER BY `id` DESC");
                                            $resultCompleted = mysqli_query($con,"SELECT * FROM `complaints` WHERE `ComplaintStatus` = 'Resolved' AND `LoggerID` = '$UserID'  ORDER BY `id` DESC");
                                            $resultDeclined = mysqli_query($con,"SELECT * FROM `complaints` WHERE `ComplaintStatus` = 'Declined' AND `LoggerID` = '$UserID' ORDER BY `id` DESC");
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="tab-content" id="myTabContent">
                                                            ...
                                                            <div class="tab-pane fade" id="profile<?php echo $res['id']; ?>" role="tabpanel" aria-labelledby="profile-tab">
                                                                ...
                                                                <form class="row mt-4" action="citizen" method="POST">
                                                                    <div class="col">
                                                                    ...
                                                                    <div class="card mb-3" style="cursor:pointer;">
                                                                        <div class="media Reply<?php echo $resComplaint['id']; ?>" role="menu" data-toggle="collapse" data-target="#Reply<?php echo $resComplaint['id']; ?>" aria-expanded="false" aria-controls="Reply<?php echo $resComplaint['id']; ?>">
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                if($resComplaint['CommentType'] == "Approved"){ echo '<small class="text-success"> approved</small>';} 
                                                                            ?>
                                                                                </h5>
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="row mt-4 ">
                                                                                    <div class="col">
                                                                                        <form action="citizen" method="POST" class="form-group input-fields">
                                        ...
                                        <div class="todo-item all-list todo-task-done ml-3" data-toggle="modal" data-target="#ApprovedModal<?php echo $res['id']; ?>">
                                            <div class="todo-item-inner">
                                                <div class="todo-content">
                                                    ...
                                                    <p class="meta-date text-success"><?php echo $res['Date'].' - Resolved'; ?></p>
                                                    <p class="meta-date"><?php echo $res['Date'].', '.$res['Time']; ?></p>
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="tab-content" id="myTabContent">
                                                            <div class="tab-pane fade show active" id="home<?php echo $res['id']; ?>" role="tabpanel" aria-labelledby="home-tab">
                                                                <p class="modal-text"><span class='badge outline-badge-success'><?php echo $res['ComplaintStatus']; ?></span> - <?php echo $res['Complaint']; ?>.</p>
                                                                <p class="modal-text mt-4">Resolution - <?php echo $res['ResolvedReason']; ?>.</p>
                                                                    ...
                                                                    <div class="card mb-3" style="cursor:pointer;">
                                                                        <div class="media Reply<?php echo $resComplaint['id']; ?>" role="menu" data-toggle="collapse" data-target="#Reply<?php echo $resComplaint['id']; ?>" aria-expanded="false" aria-controls="Reply<?php echo $resComplaint['id']; ?>">
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                if($resComplaint['CommentType'] == "Comment"){ echo '<small class="text-info"> commented</small>';}
                                                                                if($resComplaint['CommentType'] == "Approved"){ echo '<small class="text-success"> approved</small>';} 
                                                                                if($resComplaint['CommentType'] == "Completed"){ echo '<small class="text-success"> resolved complaint</small>';} 
                                                                            ?>
                                                                                </h5>
                                                                                <p class="media-text"><?php echo $resComplaint['Comment']; ?></p>
                                                                            </div>
